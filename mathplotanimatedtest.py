...
def tempGet():
    sql = "SELECT Temperature FROM sensorData WHERE Date =" + example
    cursor.execute(sql)
...
def timeGet():
    sql = "SELECT Time FROM sensorData" + example
    cursor.execute(sql)
    rows = cursor.fetchall()
...
def lightGet():
    sql = "SELECT LightLevel FROM sensorData" + example
    cursor.execute(sql)
    rows = cursor.fetchall()
...
def dateGet():
    sql = "SELECT Date FROM sensorData" + example
    cursor.execute(sql)
    rows = cursor.fetchall()
